...
a Ravel to a variable (preferably via a \htmlref{Lock}{Lock}, so that
...
operators. For more details see \htmlref{\emph{Operations}}{Operations}.
...
by country over time. For more details see \htmlref{\emph{Linking Ravels}}{Linking-Ravels}.
...
\htmlref{\emph{Sheet}}{Sheet} and \htmlref{\emph{Plot Widget}}{PlotWidget}.
...
details see \htmlref{\emph{Publication tabs}}{tabs:Publication}.
...
which as data. For more details see \htmlref{\emph{Importing data into a parameter from a CSV file}}{Operation:csvImport}.
