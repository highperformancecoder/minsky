...
variable). Click on \smhtmladdimg{var.png} on the Icon Palette, or
...
\smhtmladdimg{const.png} on the Palette, or by choosing
...
\smhtmladdimg{NewItem89.png}, define a constant and give it
...
icon. Right-click or double-click on it to rename int2 to Capital, and
