...
variable). Click on \smhtmladdimg{NewItem58.png} on the Icon Palette, or click on the Operations
...
later). For this we need to add a constant by clicking on \smhtmladdimg{NewItem61.png} on the
...
constant \smhtmladdimg{NewItem67.png}  will now be attached to the
...
\smhtmladdimg{NewItem69.png} symbol on the palette and the symbol will
...
\smhtmladdimg{NewItem72.png}  and click, hold the mouse button down, and
drag. An arrow will come out from  \smhtmladdimg{NewItem72.png}. Drag
...
Then click on \smhtmladdimg{NewItem78.png} in the Design Icons to create a new variable, call it
...
rate---another variable. Click on \smhtmladdimg{NewItem82.png}, give it
...
from the actual employment rate $\lambda$. To enter 1, click on \smhtmladdimg{NewItem89.png}, define a
...
define it by clicking on the \smhtmladdimg{NewItem91.png} symbol in the Icon Palette (or by
...
new integral variable Capital using the \smhtmladdimg{NewItem101.png}
...
\smhtmladdimg{NewItem106.png} icon, placing the graph
...
\smhtmladdimg{NewItem170.png} key
next to ``Patient lends to Impatient'' to create a blank row:

\fwhtmladdimg{NewItem171.png}
