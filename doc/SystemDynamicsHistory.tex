...
(normally in
\htmladdnormallink{FORTRAN}{http://en.wikipedia.org/wiki/FORTRAN}). The
...
Forrester}{http://en.wikipedia.org/wiki/Jay_Forrester}, an engineer
who had designed
\htmladdnormallink{Whirlwind}{http://en.wikipedia.org/wiki/Whirlwind_(computer)}(the
...
\htmladdnormallink{CRT}{http://en.wikipedia.org/wiki/Cathode_ray_tube}
...
SIMPLE came
\htmladdnormallink{DYNAMO}{http://en.wikipedia.org/wiki/DYNAMO_(programming_language)}
