...
page}{https://minsky.sourceforge.io} to download the version you
need. Linux packages are available from the \htmladdnormallink{OpenSUSE
...
LaTeX implemention doesn't support breqn, untick the \htmlref{wrap
...
such as \htmladdnormallinkfoot{MatLab}{https://en.wikipedia.org/wiki/MATLAB}
...
%begin{latexonly}
\begin{tabular}{ccc}
\resizebox{0.45\textwidth}{!}{\includegraphics{images/selectionExamplePrior}}  & \raisebox{1.5cm}{$\Rightarrow$}  & \resizebox{0.45\textwidth}{!}{\includegraphics{images/selectionExamplePost}}\tabularnewline
\end{tabular}%end{latexonly}
\begin{rawhtml} \textless table\textgreater{} \textless tr\textgreater{}
\textless td\textgreater\textless img src="selectionExamplePrior.png">\textless /td\textgreater{}
\textless td\textgreater\textless big\textgreater\&\#x21d2;\textless /big\textgreater\textless /td\textgreater{}
\textless td\textgreater\textless img src="selectionExamplePost.png">\textless /td\textgreater{}
\textless /tr\textgreater{} \textless /table\textgreater{} \end{rawhtml}
\item \label{edit:group} Create a \htmlref{group}{Group} using the
contents of the selection. Groups allow you to organise more complicated
systems specification into higher level modules that make the overall
...
This menu contains a set of \htmlref{mathematical operator blocks}{Operations}
for placement on the Canvas. You can get the same effect by clicking
on the Design Icons. Also present are entries for \htmlref{Godley
table items}{godley} and \htmlref{Plots}{PlotWidget}.
...
These are the ``nuts and bolts'' of any system dynamics program.
...
file. See \htmlref{Importing CSV files}{Operation:csvImport}.
...
\item [{Binary operations}] \buttonIcon{add.eps}. These execute the
...
model. We discuss this later in the \htmlref{Tutorial (Monetary)}{tut:basicBankModel}.
...
run the model by clicking on\smhtmladdimg{NewItem130.png} :
\begin{center}
...
%\end{center}
\begin{center}
\scalebox{.5}{\includegraphics{images/godleyTableWithAccounts}} 
\par\end{center}

As you enter the accounts, they appear at the bottom of the Bank block
on the canvas:
\begin{center}
\scalebox{0.5}{\includegraphics{images/NewItem145}} 
\par\end{center}
...
%\end{center}
\begin{center}
\scalebox{.5}{\includegraphics{images/godleyTableWithAccounts1}} 
\par\end{center}
...
\begin{center}
\scalebox{.5}{\includegraphics{images/godleyTableWithAccounts2}} 
\par\end{center}
...
\begin{center}
\scalebox{.5}{\includegraphics{images/godleyTableWithAccounts3}} 
\par\end{center}
...
\begin{center}
\scalebox{.5}{\includegraphics{images/godleyTableWithAccounts4}} 
\par\end{center}
...
block:
\begin{center}
\scalebox{0.5}{\includegraphics{images/NewItem147}} 
\par\end{center}
...
side of Lend:
\begin{center}
\scalebox{0.5}{\includegraphics{images/NewItem149}} 
\par\end{center}
...
per year.
\begin{center}
\scalebox{0.7}{\includegraphics{images/NewItem151}} 
\par\end{center}
...
\begin{center}
\scalebox{0.7}{\includegraphics{images/NewItem152}} 
\par\end{center}
...
\begin{center}
\resizebox{\textwidth}{!}{\includegraphics{images/NewItem155}} 
\par\end{center}
...
Tutorial on a \htmlref{Basic Banking Model}{tut:basicBankModel}
for an example. This example uses the engineering concept of a \htmlref{``time
constant''}{time-constants}, which is explained in the next section.
...
numerically:
\begin{center}
\resizebox{!}{0.9\textheight}{\includegraphics{images/NewItem157}} 
\par\end{center}
...
will be more obvious in the \htmlref{tutorial}{tutorial}.

\subsubsection{Multiple banks}

There can be any number of Godley Tables---each representing a different
