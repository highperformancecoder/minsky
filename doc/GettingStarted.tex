...
is developed; the current menu items (as at the August 2016 Cantillon release) are:
...
call a Godley Table, which looks lioke the following onscreen: 
...
button near the required input port of the operator. Connection will
be made.
