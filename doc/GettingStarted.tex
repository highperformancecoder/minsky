...
This is a \emph{Minsky}-specific feature which is covered in the \htmlref{\emph{Minsky
}}{tabs:Phillips} sections of this manual.
...
\item [{\includegraphics[width=10cm]{images/VariableDefinitionForm}}]~
\end{description}
