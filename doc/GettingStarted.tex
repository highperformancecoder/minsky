...
block}{op:data} interpolates a sequence of empirical values, which may
be generated outside of Minsky, and imported as a CSV file. This
effectively defines a piecewise linear function.

\item[Plot widget] \buttonIcon{plot.eps} Add \htmlref{plots}{Plot} to the canvas.

\item[Switch] \buttonIcon{switchIcon.eps} Add \htmlref{a piecewise-defined function block}{switch} 
