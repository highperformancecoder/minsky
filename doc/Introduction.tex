...
\end{itemize}
It also includes the system-dynamics engine \htmlref{\emph{Minsky}}{Introduction-Minsky}.
...
releases). Once the data is \htmlref{imported}{CSV import}, the data object
...
where the \buttonIcon{mean}operator works out the average
