...
Symbolically differentiates its input, producing d/dx[input]. For example, if you input
$kx^n$ where k is a constant, and differentiate with respect to x, the output will be
$nkx^(n-1)$.
