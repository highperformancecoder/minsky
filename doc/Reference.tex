...
This feature checks the current system to make sure all dimensions are
using the same units of measurement. Provided this is the case, selecting this
from the File dropdown menu will return the pop-up text ``Dimension
Analysis passed''. For further explanation regarding Dimensional Analysis, 
see \href{https://en.wikipedia.org/wiki/Dimensional_analysis}{this wikipedia page}.
