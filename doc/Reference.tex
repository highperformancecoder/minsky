...
\subsection{Polygamma $\psi^{(n)}(x)$} Returns the polygamma function
of the first argument $x$, with the order $n$ being goven by the floor
...
\section{Variables}\label{Variable:constant}\label{VarConstant}\label{Variable:parameter}
