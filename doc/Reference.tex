...
defined variable in the system. This is a convenience toolbar that
allows one to select a variable for insertion into the design canvas,
instead of having to type the new variables name from scratch.

At the top of the variable browser is some filter checkboxes, that
