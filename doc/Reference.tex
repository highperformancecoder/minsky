...
an amount between the asset and liability collumn, you might write
...
The Godley table also returns the value of the entered variable, displayed within the table.
For example, if you set ``Amount" to equal the value of system time, and then opened
the Godley table, wherever you entered ``Amount" in the table would read
