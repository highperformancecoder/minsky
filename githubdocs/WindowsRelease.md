...
- Install lld on your system, then link it to the MXE linker `ln -sf /usr/bin/ld.lld $(MINSKYHOME)/usr/bin/x86_64-w64-mingw32.shared-ld`. This make a dramatic improvement to build times, with the link portion of the build shrinking from over 13 minutes to less than 2 second.
