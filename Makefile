...
MODEL_OBJS=wire.o item.o group.o minsky.o port.o operation.o variable.o switchIcon.o \
	godleyTable.o cairoItems.o godleyIcon.o SVGItem.o plotWidget.o canvas.o panopticon.o \
	godleyTableWindow.o ravelWrap.o sheet.o CSVDialog.o selection.o itemTab.o \
	variableInstanceList.o autoLayout.o userFunction.o userFunction_units.o
ENGINE_OBJS=coverage.o derivative.o equationDisplay.o equations.o evalGodley.o evalOp.o \
	flowCoef.o godleyExport.o latexMarkup.o variableValue.o node_latex.o node_matlab.o \
	CSVParser.o minskyTensorOps.o mdlReader.o
