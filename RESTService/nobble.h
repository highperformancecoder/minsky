...
NOBBLE(NOBBLE_TARG(__gnu_cxx::__normal_iterator<const unsigned int*, std::vector<T,A>>),NOBBLE_TARG(class T,class A))
NOBBLE(NOBBLE_TARG(__gnu_cxx::__normal_iterator<const long unsigned int*, std::vector<T,A>>),NOBBLE_TARG(class T,class A))
NOBBLE(NOBBLE_TARG(__gnu_cxx::__normal_iterator<const long long unsigned int*, std::vector<T,A>>),NOBBLE_TARG(class T,class A))
