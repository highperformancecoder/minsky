...
minsky.databaseIngestor.connect("sqlite3","db=foo.sqlite","citibike")
...
minsky.databaseIngestor.createTable(filenames[0],spec())
minsky.databaseIngestor.loadDatabase(filenames,spec())
