...
namespace minsky
{
  ...
  public:
    ...
    void zoom(double, double, double z) override {GodleyTableEditor::zoomFactor*=z; requestRedraw();}
    double zoomFactor() const override {return GodleyTableEditor::zoomFactor;}
