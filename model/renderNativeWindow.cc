...
namespace minsky
{
  ...
  {
    winInfoPtr.reset();
    winInfoPtr = std::make_shared<WindowInformation>(parentWindowId, offsetLeft, offsetTop, childWidth, childHeight, scalingFactor, hasScrollBars(), extraVerticalTranslation(), [this](){draw();});
