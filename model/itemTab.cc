...
//    if (!itemVector.empty())
//      {
//        float x0, y0=1.5*rowHeight;//+cellPtr->height();	
...
//                          cellPtr->setMarkup(i);
//                          cellPtr->show();                  
//                          colWidths[vACtr]=std::max(colWidths[vACtr],5+cellPtr->width());
//                          x+=colWidths[vACtr];
...
//                        cellPtr->setMarkup(latexToPango(i));
//                        cellPtr->show();                    
//                        colWidths[vACtr]=std::max(colWidths[vACtr],5+cellPtr->width()); 
//                        x+=colWidths[vACtr];
//                        vACtr++;
...
//                  {
//                    cairo_move_to(cairo,x,y-1.5*rowHeight);
//                    cellPtr->setMarkup(latexToPango(value->name)+"="+latexToPango(def));
//                    cellPtr->show();                                  
//                    string format=value->hypercube().xvectors[0].dimension.units;
//                    for (auto& i: value->hypercube().xvectors[0])
//                      {
//                        cairo_move_to(cairo,x,y);
//                        cellPtr->setText(trimWS(str(i,format)));
//                        cellPtr->show();
//                        y+=rowHeight;
//                        colWidth=std::max(colWidth,5+cellPtr->width());
//                      }
//                    colLeftMargin[iC].push_back(x);                         
//                    y=y0;
//                    lh=0;                        
...
//                        y=y0;
//                        cairo_move_to(cairo,x,y);
//                        cellPtr->setText(trimWS(str(value->hypercube().xvectors[labelDim2][i],format)));
//                        cellPtr->show();
//                        { // draw vertical grid line
//                          cairo::CairoSave cs(cairo);
//                          cairo_set_source_rgba(cairo,0,0,0,0.5);
...
//                            if (!std::isnan(v))
//                              {
//                                cellPtr->setText(str(v));
//                                cellPtr->show();
//                              }
//                            colWidth=std::max(colWidth, cellPtr->width());
//                          }
//                        colLeftMargin[iC].push_back(x);                     
//                        x+=colWidth;
//                        if (x>2e09) break;
