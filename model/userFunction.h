...
namespace  minsky
{
  ...
  public:
    ...
    void displayTooltip(const mansoura::IMansoura& cr, const std::string& tt) const override
    ...
    void draw(const mansoura::IMansoura& cairoShim) const override {drawUserFunction(cairoShim);}
